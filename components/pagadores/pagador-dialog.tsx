  ...
  const handleSubmit = useCallback(
    (event: React.FormEvent<HTMLFormElement>) => {
      ...
      const payload = {
        ...
        defaultSplitPercentage: formState.defaultSplitPercentage,
      };
  ...
  return (
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      ...
      <DialogContent className="flex max-h-[90vh] max-w-2xl flex-col gap-0 overflow-hidden p-0">
        <DialogHeader className="px-6 py-5 sm:px-8 sm:pb-2 sm:pt-6">
        ...
        >
          <div className="flex-1 overflow-y-auto px-6 py-2 sm:px-8">
            <fieldset className="flex flex-col gap-3">
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-2">
                  <Label htmlFor="pagador-split">
                    Porcentagem de Divisão Padrão (%)
                  </Label>
                  <Input
                    id="pagador-split"
                    type="number"
                    min="0"
                    max="100"
                    value={formState.defaultSplitPercentage}
                    onChange={(event) =>
                      updateField(
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Define a porcentagem padrão que este pagador assume em
                    divisões.
                  </p>
                </div>
              </div>
          ...
          <DialogFooter className="gap-3 px-6 py-5 sm:px-8 sm:py-6">
            <Button
              type="button"
              variant="outline"
