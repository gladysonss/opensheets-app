...
const chartConfig = {
  total: {
    label: "Total",
    color: "hsl(221.2 83.2% 53.3%)", // Primary blue color
  },
};
...
export function VehicleHistoryCard({ data }: VehicleHistoryCardProps) {
    ...
    <Card className="border">
      <CardHeader className="gap-1.5 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Despesas registradas para este veículo ao longo do tempo.
        </p>
      </CardHeader>
